...
train_dataset = train_dataset.map(remove_special_characters, remove_columns=["transcript"], keep_in_memory=True,
                                  num_proc=data_args.preprocessing_num_workers)
eval_dataset = eval_dataset.map(remove_special_characters, remove_columns=["transcript"], keep_in_memory=True,
                                num_proc=data_args.preprocessing_num_workers)
